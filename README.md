...
**Description:** A gesture recognition system that determines the outcome of a rock-paper-scissors game using **hypothesis testing**. 
...
### 🐶 CNN-Based Dog Breed Classification
**Description:** A **convolutional neural network (CNN)** model trained to classify dog breeds based on image inputs.

🔗 [Project Repository](https://github.com/majasts/CNN-Based-Dog-Breed-Classification)
